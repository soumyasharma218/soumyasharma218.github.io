...
public class MainActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		 ...
		 * 
		 * @Override public void onResponse(JSONObject response) { Log.d("App",
		 * response.toString()); responseText.setText("Response:" + " "
		 * +response.toString()); pDialog.hide(); } }, new
		 * Response.ErrorListener() {
		 * 
		 * @Override public void onErrorResponse(VolleyError error) {
		 * VolleyLog.d("App", "Error: " + error.getMessage()); // hide the
		 * progress dialog pDialog.hide(); } });
		 * 
