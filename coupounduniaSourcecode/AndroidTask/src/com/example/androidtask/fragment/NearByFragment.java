...
public class NearByFragment extends Fragment implements ConnectionCallbacks,
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
	 ...
	 myInflatedView = inflater.inflate(R.layout.nearby, container,
				false);
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		listView = (ListView) myInflatedView
				.findViewById(R.id.offers);
		fragmentInit();
...
;								
	...
	public void fragmentInit() {
		...
		System.out.println(nearbyListAdapter+":<<<<<<<<<<<<<<<,"+listView);
	...
	private void displayLocation() {
		...
		if (mLastLocation != null) {
			...
			try {
				...
				locationnearby.setText(address);
				pDialog.dismiss();
			} catch (IOException e) {
				// TODO Auto-generated catch block
				e.printStackTrace();
